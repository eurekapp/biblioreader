...
public class FixedPagesStrategyTest {
    ...
    public void testEmptyText() {
        Spanned text = LayoutTextUtil.getSpanned("");
    ...
    public void testOneLinePage() {
        ...
        initMockLayout(5, 105);
         ...
         Spanned text = LayoutTextUtil.getSpanned("1234");
	...
	public void testPageTurning() {
        ...
        String page1 = LayoutTextUtil.getStringOfLength("ABCDEFGHIJ", 50);
        String page2 = LayoutTextUtil.getStringOfLength("012345", 50);
        String page3 = LayoutTextUtil.getStringOfLength("XYZABC", 25);

		Spanned text = LayoutTextUtil.getSpanned(page1 + page2 + page3);
