...
import net.eurekapp.nucular.atom.AtomConstants;
import net.eurekapp.nucular.atom.Entry;
import net.eurekapp.nucular.atom.Link;
import net.eurekapp.pageturner.Configuration;
import net.eurekapp.pageturner.CustomOPDSSite;
import net.eurekapp.pageturner.catalog.Catalog;
import net.eurekapp.pageturner.catalog.CatalogParent;
import net.eurekapp.pageturner.catalog.LoadFeedCallback;
import net.eurekapp.pageturner.fragment.BookDetailsFragment;
import net.eurekapp.pageturner.fragment.CatalogFragment;
import net.eurekapp.nucular.atom.Feed;
...
public class CatalogActivity extends PageTurnerActivity implements CatalogParent {
    ...
    @Nullable
    @InjectFragment(net.eurekapp.pageturner.R.id.fragment_book_details)
    ...
    protected int getMainLayoutResource() {
        return net.eurekapp.pageturner.R.layout.activity_catalog;
    }
    ...
    public void loadCustomSitesFeed() {
        ...
        customSites.setTitle(getString(net.eurekapp.pageturner.R.string.custom_site));
...
//        }
        ...
        fragmentTransaction.replace(net.eurekapp.pageturner.R.id.fragment_catalog, newCatalogFragment, Catalog.CUSTOM_SITES_ID);
    ...
    public void loadFeed(Entry entry, String href, String baseURL, boolean asDetailsFeed) {
        ...
        fragmentTransaction.replace(net.eurekapp.pageturner.R.id.fragment_catalog, newCatalogFragment, baseURL);
