...
public class ScrollingStrategy implements PageChangeStrategy {
	...
	private Spannable addEndTag(SpannableStringBuilder builder) {
		...
		builder.append("\uFFFC");
		builder.append("\n");
		builder.append( context.getString(net.eurekapp.pageturner.R.string.end_of_section));
		...
		Drawable img = context.getResources().getDrawable(net.eurekapp.pageturner.R.drawable.gateway);
