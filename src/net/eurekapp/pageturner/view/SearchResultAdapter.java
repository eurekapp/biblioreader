...
package net.eurekapp.pageturner.view;
...
public class SearchResultAdapter extends ArrayAdapter<SearchResult> implements
	...
	public SearchResultAdapter(Context context, BookView bookView, 
		...
		super(context, net.eurekapp.pageturner.R.id.deviceName, books);
		this.results = books;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if ( convertView == null ) {
			...
			rowView = inflater.inflate(net.eurekapp.pageturner.R.layout.progress_row, parent, false);
		} else {
			rowView = convertView;
		}

		TextView deviceView = (TextView) rowView.findViewById(net.eurekapp.pageturner.R.id.deviceName);
		TextView percentageView = (TextView) rowView.findViewById(net.eurekapp.pageturner.R.id.timeStamp );
        ...
        if ( pageNumber != -1 ) {
            text = String.format( getContext().getString(net.eurekapp.pageturner.R.string.page_number_of),
