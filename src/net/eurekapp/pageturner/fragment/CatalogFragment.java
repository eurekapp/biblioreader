...
import net.eurekapp.pageturner.catalog.CatalogListAdapter;
import net.eurekapp.pageturner.catalog.CatalogParent;
import net.eurekapp.pageturner.catalog.LoadFeedCallback;
import net.eurekapp.pageturner.catalog.LoadOPDSTask;
import net.eurekapp.pageturner.catalog.LoadThumbnailTask;
import net.eurekapp.pageturner.catalog.ParseBinDataTask;
