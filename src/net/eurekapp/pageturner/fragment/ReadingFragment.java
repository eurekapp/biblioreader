...
import net.eurekapp.pageturner.animation.Animations;
import net.eurekapp.pageturner.animation.Animator;
import net.eurekapp.pageturner.animation.PageCurlAnimator;
import net.eurekapp.pageturner.animation.PageTimer;
import net.eurekapp.pageturner.animation.RollingBlindAnimator;
import net.eurekapp.pageturner.view.AnimatedImageView;
import net.eurekapp.pageturner.view.HighlightManager;
import net.eurekapp.pageturner.view.NavGestureDetector;
import net.eurekapp.pageturner.view.NavigationCallback;
import net.eurekapp.pageturner.view.ProgressListAdapter;
import net.eurekapp.pageturner.view.SearchResultAdapter;
import net.eurekapp.pageturner.view.bookview.BookView;
import net.eurekapp.pageturner.view.bookview.BookViewListener;
import net.eurekapp.pageturner.view.bookview.SelectedWord;
import net.eurekapp.pageturner.view.bookview.TextLoader;
import net.eurekapp.pageturner.view.bookview.TextSelectionCallback;
import net.nightwhistler.htmlspanner.spans.CenterSpan;
import net.eurekapp.pageturner.Configuration;
import net.eurekapp.pageturner.Configuration.AnimationStyle;
import net.eurekapp.pageturner.Configuration.ColourProfile;
import net.eurekapp.pageturner.Configuration.ReadingDirection;
import net.eurekapp.pageturner.Configuration.ScrollStyle;
import net.eurekapp.pageturner.R;
import net.eurekapp.pageturner.TextUtil;
import net.eurekapp.pageturner.activity.LibraryActivity;
import net.eurekapp.pageturner.activity.MediaButtonReceiver;
import net.eurekapp.pageturner.activity.ReadingActivity;
import net.eurekapp.pageturner.bookmark.Bookmark;
import net.eurekapp.pageturner.bookmark.BookmarkDatabaseHelper;
import net.eurekapp.pageturner.dto.HighLight;
import net.eurekapp.pageturner.dto.SearchResult;
import net.eurekapp.pageturner.dto.TocEntry;
import net.eurekapp.pageturner.epub.SearchTextTask;
import net.eurekapp.pageturner.library.LibraryService;
import net.eurekapp.pageturner.sync.AccessException;
import net.eurekapp.pageturner.sync.BookProgress;
import net.eurekapp.pageturner.sync.ProgressService;
import net.eurekapp.pageturner.tts.TTSPlaybackItem;
import net.eurekapp.pageturner.tts.TTSPlaybackQueue;
import net.eurekapp.ui.ActionModeBuilder;
...
import static net.eurekapp.pageturner.PlatformUtil.executeTask;
import static net.eurekapp.pageturner.PlatformUtil.isIntentAvailable;
