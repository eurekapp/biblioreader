...
public class AddBookmarkFragment extends RoboSherlockDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(net.eurekapp.pageturner.R.layout.fragment_add_bookmark, null);

        this.inputField = (EditText) view.findViewById(net.eurekapp.pageturner.R.id.bookmark_name);
        ...
        return new AlertDialog.Builder(
                getActivity())
                .setTitle(net.eurekapp.pageturner.R.string.add_bookmark)
                .setView( view )
                .setPositiveButton(net.eurekapp.pageturner.R.string.add, (dialog, which) -> handleAction() )
