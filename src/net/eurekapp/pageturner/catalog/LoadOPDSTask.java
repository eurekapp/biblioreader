 ...
 */
package net.eurekapp.pageturner.catalog;
...
import net.eurekapp.nucular.parser.Nucular;
import net.eurekapp.nucular.parser.opensearch.SearchDescription;
...
//todo de aca para abajo queda sin usar
	...
	private void addCustomSitesEntry(Feed feed) {
		...
		entry.setTitle(context.getString(net.eurekapp.pageturner.R.string.custom_site));
		entry.setSummary(context.getString(net.eurekapp.pageturner.R.string.custom_site_desc));
