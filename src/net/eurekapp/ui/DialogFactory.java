...
public class DialogFactory {
	...
	public AlertDialog buildAboutDialog() {
		...
		builder.setTitle(net.eurekapp.pageturner.R.string.about);
		builder.setIcon(net.eurekapp.pageturner.R.drawable.page_turner);
		...
		String html = "<h2>" + context.getString(net.eurekapp.pageturner.R.string.app_name) + " " +  version + "</h2>";
		html += context.getString(net.eurekapp.pageturner.R.string.about_gpl);
