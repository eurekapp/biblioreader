...
package org.eurekapp.pageturner.view;
...
public class SearchResultAdapter extends ArrayAdapter<SearchResult> implements
	...
	public SearchResultAdapter(Context context, BookView bookView, 
		...
		super(context, org.eurekapp.pageturner.R.id.deviceName, books);
		this.results = books;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if ( convertView == null ) {
			...
			rowView = inflater.inflate(org.eurekapp.pageturner.R.layout.progress_row, parent, false);
		} else {
			rowView = convertView;
		}

		TextView deviceView = (TextView) rowView.findViewById(org.eurekapp.pageturner.R.id.deviceName);
		TextView percentageView = (TextView) rowView.findViewById(org.eurekapp.pageturner.R.id.timeStamp );
        ...
        if ( pageNumber != -1 ) {
            text = String.format( getContext().getString(org.eurekapp.pageturner.R.string.page_number_of),
