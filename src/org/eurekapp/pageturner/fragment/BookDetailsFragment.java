...
import org.eurekapp.pageturner.catalog.Catalog;
import org.eurekapp.pageturner.catalog.DownloadFileTask;
...
import org.eurekapp.pageturner.catalog.LoadFeedCallback;
import org.eurekapp.pageturner.catalog.LoadThumbnailTask;
...
public class BookDetailsFragment extends RoboSherlockFragment implements LoadFeedCallback {
    ...
    @InjectView(org.eurekapp.pageturner.R.id.mainLayout)
    private View mainLayout;

    @InjectView(R.id.itemAuthor)
    private TextView authorTextView;

    @InjectView(org.eurekapp.pageturner.R.id.itemIcon)
    private ImageView icon;

    @InjectView(R.id.buyNowButton)
    private Button buyNowButton;

    @InjectView(org.eurekapp.pageturner.R.id.firstDivider)
    @Nullable
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(org.eurekapp.pageturner.R.layout.catalog_download, container, false);
    }
...
//        }
        ...
        if (entry.getAuthor() != null) {
            String authorText = String.format(
                    getString(org.eurekapp.pageturner.R.string.book_by), entry.getAuthor()
                    .getName());
        ...
        icon.setImageDrawable( getActivity().getResources().getDrawable(org.eurekapp.pageturner.R.drawable.unknown_cover));
    ...
    public void emptyFeedLoaded(Feed feed) {
        errorLoadingFeed( getActivity().getString(org.eurekapp.pageturner.R.string.empty_opds_feed) );
    }
    ...
    private class NotificationBarCallback extends AbstractDownloadCallback {
        ...
        public NotificationBarCallback(Context context, String title,
            ...
            this.downloadFailed = getString(org.eurekapp.pageturner.R.string.book_failed);
        ...
        public void onDownloadStart() {
            ...
            builder.setContentTitle(title)
                    ...
                    .setSmallIcon(org.eurekapp.pageturner.R.drawable.download);
    ...
    private class ProgressDialogCallback extends AbstractDownloadCallback implements
        ...
        @Override
        public void onDownloadStart() {
            downloadDialog.setMessage(getString(org.eurekapp.pageturner.R.string.downloading));
            downloadDialog.show();
        }
        ...
        public void downloadSuccess(File destFile) {
            ...
            if ( ! isOpenOnCompletion() ) {
                Toast.makeText(getActivity(), org.eurekapp.pageturner.R.string.download_complete,
