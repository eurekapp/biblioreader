...
import org.eurekapp.pageturner.fragment.ReadingFragment;
    ...
    protected List<NavigationCallback> getMenuItems( Configuration config ) {
        ...
        if ( this.readingFragment != null ) {
            ...
            if ( this.readingFragment.hasBookmarks() ) {
                NavigationCallback bookmarksCallback = new NavigationCallback(getString(org.eurekapp.pageturner.R.string.bookmarks));
