 ...
 */
package org.eurekapp.pageturner.activity;
...
import org.eurekapp.pageturner.CustomOPDSSite;
import org.eurekapp.pageturner.PageTurner;
...
public class ManageSitesActivity extends RoboSherlockListActivity {
	...
	public boolean onPrepareOptionsMenu(Menu menu) {
		...
		inflater.inflate(org.eurekapp.pageturner.R.menu.edit_sites_menu, menu);
	...
	public void onCreateContextMenu(ContextMenu menu, View v,
		...
		menu.add(Menu.NONE, ContextAction.EDIT.ordinal(), Menu.NONE, org.eurekapp.pageturner.R.string.edit );
		menu.add(Menu.NONE, ContextAction.DELETE.ordinal(), Menu.NONE, org.eurekapp.pageturner.R.string.delete);
	...
	private void showEditDialog(final CustomOPDSSite site) {
		showSiteDialog(org.eurekapp.pageturner.R.string.edit_site, site);
	}
	
	private void showAddSiteDialog() {		
		showSiteDialog(org.eurekapp.pageturner.R.string.add_site, null);
	}
	...
	private void showSiteDialog(int titleResource, final CustomOPDSSite siteParam ) {
		...
		View layout = inflater.inflate(org.eurekapp.pageturner.R.layout.edit_site, null);
		builder.setView(layout);
		
		final TextView siteName = (TextView) layout.findViewById(org.eurekapp.pageturner.R.id.siteName);
		final TextView siteURL = (TextView) layout.findViewById(org.eurekapp.pageturner.R.id.siteUrl);
		final TextView siteDesc = (TextView) layout.findViewById(org.eurekapp.pageturner.R.id.siteDescription);
		final TextView userName = (TextView) layout.findViewById(org.eurekapp.pageturner.R.id.username);
		final TextView password = (TextView) layout.findViewById(org.eurekapp.pageturner.R.id.password);
        ...
        builder.setPositiveButton(org.eurekapp.pageturner.R.string.save, (dialog, which) -> {
            if ( siteName.getText().toString().trim().length() == 0 ) {
                Toast.makeText(ManageSitesActivity.this, org.eurekapp.pageturner.R.string.msg_name_blank, Toast.LENGTH_SHORT).show();
                return;
            }

            if ( siteURL.getText().toString().trim().length() == 0 ) {
                Toast.makeText(ManageSitesActivity.this, org.eurekapp.pageturner.R.string.msg_url_blank, Toast.LENGTH_SHORT).show();
                return;
            }
	...
	private class CustomOPDSSiteAdapter extends ArrayAdapter<CustomOPDSSite> {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if ( convertView != null ) {
				...
				view = ( (LayoutInflater) getSystemService(Context.LAYOUT_INFLATER_SERVICE) ).inflate(org.eurekapp.pageturner.R.layout.manage_sites, null);
			}
			
			TextView siteName = (TextView) view.findViewById( org.eurekapp.pageturner.R.id.siteName );
			TextView description = (TextView) view.findViewById( org.eurekapp.pageturner.R.id.siteDescription );
