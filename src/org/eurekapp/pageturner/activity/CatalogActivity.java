...
import org.eurekapp.pageturner.catalog.CatalogParent;
import org.eurekapp.pageturner.catalog.LoadFeedCallback;
import org.eurekapp.pageturner.fragment.BookDetailsFragment;
import org.eurekapp.pageturner.fragment.CatalogFragment;
...
public class CatalogActivity extends PageTurnerActivity implements CatalogParent {
    ...
    @Nullable
    @InjectFragment(org.eurekapp.pageturner.R.id.fragment_book_details)
    ...
    protected int getMainLayoutResource() {
        return org.eurekapp.pageturner.R.layout.activity_catalog;
    }
    ...
    public void loadCustomSitesFeed() {
        ...
        customSites.setTitle(getString(org.eurekapp.pageturner.R.string.custom_site));
...
//        }
        ...
        fragmentTransaction.replace(org.eurekapp.pageturner.R.id.fragment_catalog, newCatalogFragment, Catalog.CUSTOM_SITES_ID);
    ...
    public void loadFeed(Entry entry, String href, String baseURL, boolean asDetailsFeed) {
        ...
        fragmentTransaction.replace(org.eurekapp.pageturner.R.id.fragment_catalog, newCatalogFragment, baseURL);
