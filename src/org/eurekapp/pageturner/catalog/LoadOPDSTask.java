 ...
 */
package org.eurekapp.pageturner.catalog;
...
import org.eurekapp.nucular.parser.Nucular;
import org.eurekapp.nucular.parser.opensearch.SearchDescription;
...
//todo de aca para abajo queda sin usar
	...
	private void addCustomSitesEntry(Feed feed) {
		...
		entry.setTitle(context.getString(org.eurekapp.pageturner.R.string.custom_site));
		entry.setSummary(context.getString(org.eurekapp.pageturner.R.string.custom_site_desc));
