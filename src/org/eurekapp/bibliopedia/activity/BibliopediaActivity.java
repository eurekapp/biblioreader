...
/**
 * Superclass for all Bibliopedia activity classes.
 */
public abstract class BibliopediaActivity extends RoboSherlockFragmentActivity {
    ...
    private static Logger LOG = LoggerFactory.getLogger("BibliopediaActivity");
    ...
    protected final void onCreate(Bundle savedInstanceState) {
        ...
        mToggle = new ActionBarDrawerToggleCompat(this, mDrawer, R.drawable.ic_drawer, R.string.drawer_open, R.string.drawer_close) {
            public void onDrawerClosed(View view) {
                BibliopediaActivity.this.onDrawerClosed(view);
            }

            public void onDrawerOpened(View drawerView) {
                BibliopediaActivity.this.onDrawerOpened(drawerView);
            }
        };
        ...
        onCreateBibliopediaActivity(savedInstanceState);
    ...
    protected List<NavigationCallback> getMenuItems( Configuration config ) {
        ...
        //config.getInst();
        result.add( new NavigationCallback(config.getInst()));
    ...
    protected NavigationCallback navigate( String title, Class<? extends BibliopediaActivity> classToStart ) {
    ...
    public void launchActivity(Class<? extends BibliopediaActivity> activityClass) {
