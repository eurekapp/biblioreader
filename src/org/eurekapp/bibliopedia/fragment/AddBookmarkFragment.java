...
public class AddBookmarkFragment extends RoboSherlockDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(org.eurekapp.bibliopedia.R.layout.fragment_add_bookmark, null);

        this.inputField = (EditText) view.findViewById(org.eurekapp.bibliopedia.R.id.bookmark_name);
        ...
        return new AlertDialog.Builder(
                getActivity())
                .setTitle(org.eurekapp.bibliopedia.R.string.add_bookmark)
                .setView( view )
                .setPositiveButton(org.eurekapp.bibliopedia.R.string.add, (dialog, which) -> handleAction() )
