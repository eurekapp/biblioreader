...
//todo de aca para abajo queda sin usar
	...
	private void addCustomSitesEntry(Feed feed) {
		...
		entry.setTitle(context.getString(org.eurekapp.bibliopedia.R.string.custom_site));
		entry.setSummary(context.getString(org.eurekapp.bibliopedia.R.string.custom_site_desc));
