...
package org.eurekapp.bibliopedia.view;
...
public class SearchResultAdapter extends ArrayAdapter<SearchResult> implements
	...
	public SearchResultAdapter(Context context, BookView bookView, 
		...
		super(context, org.eurekapp.bibliopedia.R.id.deviceName, books);
		this.results = books;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if ( convertView == null ) {
			...
			rowView = inflater.inflate(org.eurekapp.bibliopedia.R.layout.progress_row, parent, false);
		} else {
			rowView = convertView;
		}

		TextView deviceView = (TextView) rowView.findViewById(org.eurekapp.bibliopedia.R.id.deviceName);
		TextView percentageView = (TextView) rowView.findViewById(org.eurekapp.bibliopedia.R.id.timeStamp );
        ...
        if ( pageNumber != -1 ) {
            text = String.format( getContext().getString(org.eurekapp.bibliopedia.R.string.page_number_of),
