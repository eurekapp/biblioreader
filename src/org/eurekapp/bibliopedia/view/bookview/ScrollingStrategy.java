...
public class ScrollingStrategy implements PageChangeStrategy {
	...
	private Spannable addEndTag(SpannableStringBuilder builder) {
		...
		builder.append("\uFFFC");
		builder.append("\n");
		builder.append( context.getString(org.eurekapp.bibliopedia.R.string.end_of_section));
		...
		Drawable img = context.getResources().getDrawable(org.eurekapp.bibliopedia.R.drawable.gateway);
